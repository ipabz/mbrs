...
<div id="admin-panel">
    <div id="admin-panel-inner">
        ...
        <span>
            ...
            <a href="<?php print site_url('motorbikes/list_motorbikes'); ?>"><?php print lang('motorbike_label'); ?></a>
            <a href=""><?php print lang('reports_label'); ?></a>
            <?php if($this->session->userdata('admin_id') == '1') { ?>
            <a href="<?php print site_url('account/account_list'); ?>"><?php print lang('account_label'); ?></a>
            <?php } else { ?>
            <a href="<?php print site_url('account/account_list/edit/'.$this->session->userdata('admin_id')); ?>"><?php print lang('edit_account_label'); ?></a>
            <?php } ?>
        </span> 
